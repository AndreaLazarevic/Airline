...
public class SaveFlight extends AbstractGenericOperation {
    ...
    public Response execute(GeneralEntity entity) throws Exception {
        ...
        try {
            ...
            response.setMessage("System successfully saved the flight.");
        } catch (SQLException ex) {
            Logger.getLogger(SaveFlight.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("System couldn't save the flight.");
        }
        return response;
    }
